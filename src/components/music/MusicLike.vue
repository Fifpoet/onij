      ...
      <div class="music-like-content w-full max-w-4xl mx-auto">
        ...
        <div class="mb-6">
          ...
          <div class="flex flex-wrap gap-2">
            <div v-for="artist in musicStore.current.detail?.artist_names" :key="artist"
        ...
        <!-- 标签组 -->
        <div v-for="group in tagOpts" :key="group.key" class="mb-6">
...
const toggleTagLike = async ( group: SelectGroupOption, tag: SelectBaseOption) => {
  const extra = JSON.parse(tag.value) as SelectTagExtra;

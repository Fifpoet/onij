...
func SetupRouter() *gin.Engine {
	...
	router.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"http://localhost:18968", "http://127.0.0.1:18968", "http://localhost:18968/", "http://127.0.0.1:18968/"}, // 允许的前端地址
		AllowMethods:     []string{"GET", "POST", "PUT", "DELETE"},                                                                           // 允许的 HTTP 方法
		AllowHeaders:     []string{"Origin", "Content-Type", "Content-Length", "Authorization", "Accept", "X-Requested-With"},                // 允许的请求头
